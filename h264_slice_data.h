...
// NOTE: these functions will need more arguments, since how they work depends
// on *what* is being encoded/decoded for now, just a placeholder for places
// that we will need to call this from
...
#define MbaffFrameFlag                                                         \
  (h->sps->mb_adaptive_frame_field_flag && !h->sh->field_pic_flag)
